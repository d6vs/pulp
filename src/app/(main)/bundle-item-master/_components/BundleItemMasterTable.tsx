...
export function BundleItemMasterTable({
  ...
  const { history, loading, addEntry, clearHistory } = useDownloadHistory("bundle_item_master")
  ...
  const handleDownloadXLSX = async () => {
    ...
    addEntry(`bundle_item_master_${selectedDate}.csv`)
  ...
  return (
    ...
    <DownloadHistoryPanel history={history} loading={loading} onClear={clearHistory} />
    </>
  )
}
